...
extern volatile unsigned char heating_enabled;        // ��������״̬
extern volatile unsigned char heating_pwr;        // ����power
extern volatile unsigned char heating_cnt;               // ռ�ձȼ���ֵ��0-10��
extern volatile unsigned char pump_speed;             // ˮ���ٶ�(0-100%)
